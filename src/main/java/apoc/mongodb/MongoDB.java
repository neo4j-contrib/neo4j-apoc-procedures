...
public class MongoDB {
    ...
    @Procedure
    @Description("apoc.mongodb.get(host-or-port,db-or-null,collection-or-null,query-or-null,compatibleValues) yield value - perform a find operation on mongodb collection")
    ...
    @Procedure
    @Description("apoc.mongodb.first(host-or-port,db-or-null,collection-or-null,query-or-null,compatibleValues) yield value - perform a first operation on mongodb collection")
    ...
    @Procedure
    @Description("apoc.mongodb.find(host-or-port,db-or-null,collection-or-null,query-or-null,projection-or-null,sort-or-null,compatibleValues) yield value - perform a find,project,sort operation on mongodb collection")
