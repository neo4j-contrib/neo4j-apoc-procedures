...
public class LoadLdapConfig {
    ...
    public LoadLdapConfig(ApocConfig storage, Map<String, Object> config, String url) {
    ...
    public static Map<String, Object> loadApocConfig(ApocConfig apocConfig, String configPrefix) {
    ...
    public LoadLdapConfig(ApocConfig storage, Map<String, Object> config) {
        this(storage, config, (String) config.get("url"));
    }
    ...
    public static LoadLdapConfig compatConfig(ApocConfig storage, Map<String, Object> connMap, Map<String, Object> searchMap) throws LdapInvalidDnException {
        ...
        return new LoadLdapConfig(storage, compatConfig, tempUrl.toString());
    }

    public static LoadLdapConfig compatConfig(ApocConfig storage, String conn, Map<String, Object> searchMap) throws LdapInvalidDnException {
        String value = (String) loadApocConfig(storage, "loadldap").get(conn + ".config");
        ...
        return compatConfig(storage, connMap, searchMap);
    }
}