...
data class AWSVirtualSentimentVirtualGraph(private val detectEntitiesResult: BatchDetectSentimentResult, private val sourceNodes: List<Node>): AWSVirtualGraph(sourceNodes, RelationshipType { "DUMMY" }, mapOf()) {
