...
class VirtualNLPGraphTest {
    ...
    fun `create virtual graph from result with one entity`() {
        ...
        val virtualGraph = VirtualNLPGraph(res, listOf(sourceNode), RelationshipType { "ENTITY" }, AWSProcedures.ENTITY_MAPPING).create()
    ...
    fun `create virtual graph from result with multiple source nodes`() {
        ...
        val virtualGraph = VirtualNLPGraph(res, listOf(sourceNode1, sourceNode2), RelationshipType { "ENTITY" }, AWSProcedures.ENTITY_MAPPING).create()
