...
class AWSProceduresTest {
    ...
    fun `create virtual graph from result with one entity`() {
        ...
        val virtualGraph = AWSProcedures.virtualGraph(res, listOf(sourceNode), mapOf("write" to false), null)
    ...
    fun `create virtual graph from result with multiple source nodes`() {
        ...
        val virtualGraph = AWSProcedures.virtualGraph(res, listOf(sourceNode1, sourceNode2), mapOf("write" to false), null)
