...
public class UUIDTest {
    ...
    public void testUUID() {
        ...
        db.execute("CALL apoc.uuid.install('Person') YIELD label RETURN label");
    ...
    public void testUUIDList() {
        ...
        // when
        db.execute("CALL apoc.uuid.install('Bar') YIELD label RETURN label");
    ...
    public void testAddWithError() {
        try {
            // when
            db.execute("CALL apoc.uuid.install('Wrong') YIELD label RETURN label");
    ...
    public void testAddWithErrorAndCustomField() {
        try {
            // when
            db.execute("CALL apoc.uuid.install('Wrong', {uuidProperty: 'foo'}) YIELD label RETURN label");
        } catch (RuntimeException e) {
            // then
            Throwable except = ExceptionUtils.getRootCause(e);
            assertTrue(except instanceof RuntimeException);
