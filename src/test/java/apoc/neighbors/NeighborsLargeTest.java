...
public class NeighborsLargeTest {
    ...
    public void setUp() throws Exception {
        ...
        TestUtil.registerProcedure(db, NeighborsLarge.class);
    ...
    public void getNeighbors2Hops() {
        TestUtil.testCall(db, "MATCH (n:First) WITH n " +
                        "CALL apoc.neighbors.large(n,'KNOWS>', 2) YIELD node AS neighbor " +
    ...
    public void getNeighbors3Hops() {
        TestUtil.testCall(db, "MATCH (n:First) WITH n " +
                        "CALL apoc.neighbors.large(n,'KNOWS>', 3) YIELD node AS neighbor " +
                        "RETURN COLLECT(neighbor) AS neighbors",
                (row) -> {
                    List<Node> neighbors = (List<Node>) row.get("neighbors");
    ...
    public void getNeighborsCount2Hops() {
        TestUtil.testCall(db, "MATCH (n:First) WITH n " +
                        "CALL apoc.neighbors.large.count(n,'KNOWS>', 2) YIELD value AS number " +
                        "RETURN number",
    ...
    public void getNeighborsCount3Hops() {
        TestUtil.testCall(db, "MATCH (n:First) WITH n " +
                        "CALL apoc.neighbors.large.count(n,'KNOWS>', 3) YIELD value AS number " +
                        "RETURN number",
    ...
    public void getNeighborsByHop2Hops() {
        TestUtil.testCall(db, "MATCH (n:First) WITH n " +
                        "CALL apoc.neighbors.large.byhop(n,'KNOWS>', 2) YIELD nodes AS neighbor " +
                        "RETURN COLLECT(neighbor) AS neighbors",
                (row) -> {
    ...
    public void getNeighborsByHop3Hops() {
        TestUtil.testCall(db, "MATCH (n:First) WITH n " +
                        "CALL apoc.neighbors.large.byhop(n,'KNOWS>', 3) YIELD nodes AS neighbor " +
                        "RETURN COLLECT(neighbor) AS neighbors",
                (row) -> {
                    List<List<Node>> neighbors = (List<List<Node>>) row.get("neighbors");
                    assertEquals(3, neighbors.size());
    ...
    public void getNeighborsByHopCount2Hops() {
        TestUtil.testCall(db, "MATCH (n:First) WITH n " +
                        "CALL apoc.neighbors.large.count.byhop(n,'KNOWS>', 2) YIELD value AS numbers " +
                        "RETURN numbers",
                (row) -> {
    ...
    public void getNeighborsByHopCount3Hops() {
        TestUtil.testCall(db, "MATCH (n:First) WITH n " +
                        "CALL apoc.neighbors.large.count.byhop(n,'KNOWS>', 3) YIELD value AS numbers " +
                        "RETURN numbers",
                (row) -> {
                    List<Long> numbers = (List<Long>) row.get("numbers");
