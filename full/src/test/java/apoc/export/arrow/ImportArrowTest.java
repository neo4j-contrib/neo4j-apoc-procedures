...
public class ImportArrowTest {
    ...
    public void testStreamRoundtripImportArrowAll() {
        final byte[] bytes = db.executeTransactionally(
                "CALL apoc.export.arrow.stream.all", Map.of(), ArrowTestUtil::extractByteArray);
    ...
    public void testFileRoundtripImportArrowAll() {
        String file = db.executeTransactionally(
                "CALL apoc.export.arrow.all('test_all.arrow') YIELD file", Map.of(), ArrowTestUtil::extractFileName);
