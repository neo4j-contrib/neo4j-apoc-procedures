...
public class LoadXls {
    ...
    public Stream<XLSResult> xls(
        ...
        try (CountingInputStream stream = FileUtils.inputStreamFor(url, null, null, null)) {
            ...
            boolean checkIgnore =
                    !ignore.isEmpty() || mappings.values().stream().anyMatch(m -> m.ignore);
    ...
    private String[] getHeader(
            boolean hasHeader, Row header, Selection selection, List<String> ignore, Map<String, Mapping> mapping)
            throws IOException {
        ...
        for (int i = selection.left; i < selection.right; i++) {
            ...
            result[i - selection.left] =
                    ignore.contains(value) || mapping.getOrDefault(value, Mapping.EMPTY).ignore ? null : value;
        }
        return result;
    }
    ...
    public static class XLSResult {
        ...
        private Map<String, Object> createMap(
                String[] header, Object[] list, boolean ignore, Map<String, Mapping> mappings) {
