...
import static apoc.util.Util.isSumOutOfRange;
...
public class LoadCsv {
    ...
    private static final Mapping EMPTY =
            new Mapping("", Collections.emptyMap(), LoadCsvConfig.DEFAULT_ARRAY_SEP, false);
    ...
    private static class CSVSpliterator extends Spliterators.AbstractSpliterator<CSVResult> {
        ...
        public CSVSpliterator(
            ...
            this.limit = isSumOutOfRange(skip, limit) ? Long.MAX_VALUE : (skip + limit);
            lineNo = skip;
