...
public class Redis {
    ...
    public Stream<ObjectResult> getSet(
            @Name("uri") String uri,
            @Name("key") Object key,
    ...
    public Stream<ObjectResult> get(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<LongResult> append(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name("value") Object value,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<LongResult> incrby(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name("amount") long amount,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<LongResult> hdel(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name("fields") List<Object> fields,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<BooleanResult> hexists(
            @Name("uri") String uri,
            @Name("key") Object key,
    ...
    public Stream<ObjectResult> hget(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name("field") Object field,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<LongResult> hincrby(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name("field") Object field,
            @Name("amount") long amount,
        ...
        return withConnection(
                uri, config, connection -> Stream.of(new LongResult(connection.hincrby(key, field, amount))));
    }

    @Procedure
    @Description("apoc.redis.hgetall(uri, key, {config}) | Execute the 'HGETALL key' command")
    public Stream<MapResult> hgetall(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<BooleanResult> hset(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name("field") Object field,
            @Name("value") Object value,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
        return withConnection(
                uri, config, connection -> Stream.of(new BooleanResult(connection.hset(key, field, value))));
    }
    ...
    public Stream<LongResult> push(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name("value") List<Object> values,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<ObjectResult> pop(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<ListResult> lrange(
            @Name("uri") String uri,
            @Name("key") Object key,
            ...
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
        return withConnection(
                uri, config, connection -> Stream.of(new ListResult(connection.lrange(key, start, stop))));
    }

    // -- Sets
    @Procedure
    @Description("apoc.redis.sadd(uri, key, members, {config}) | Execute the 'SADD key members' command")
    public Stream<LongResult> sadd(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name("members") List<Object> members,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<LongResult> scard(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<ObjectResult> spop(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<ListResult> smembers(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<ListResult> sunion(
            @Name("uri") String uri,
    ...
    public Stream<LongResult> zadd(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name("value") List<Object> scoresAndMembers,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
        return withConnection(
                uri,
                config,
                connection -> Stream.of(new LongResult(connection.zadd(
                        key,
                        scoresAndMembers.stream()
                                .map(score -> score instanceof Number ? ((Number) score).doubleValue() : score)
                                .toArray()))));
    }

    @Procedure
    @Description("apoc.redis.zcard(uri, key, {config}) | Execute the 'ZCARD key' command")
    public Stream<LongResult> zcard(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<ListResult> zrangebyscore(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name("min") long min,
            @Name("max") long max,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
        return withConnection(
                uri, config, connection -> Stream.of(new ListResult(connection.zrangebyscore(key, min, max))));
    }

    @Procedure
    @Description("apoc.redis.zrem(uri, key, members, {config}) | Execute the 'ZREM key members' command")
    public Stream<LongResult> zrem(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name("members") List<Object> members,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<ObjectResult> eval(
            @Name("uri") String uri,
            @Name("script") String script,
            @Name("outputType") String outputType,
            @Name("keys") List<Object> keys,
        ...
        return withConnection(
                uri,
                config,
                connection -> Stream.of(
                        new ObjectResult(connection.eval(script, ScriptOutputType.valueOf(outputType), keys, values))));
    }
    ...
    public Stream<BooleanResult> copy(
            @Name("uri") String uri,
            @Name("source") Object source,
            @Name("destination") Object destination,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
        return withConnection(
                uri, config, connection -> Stream.of(new BooleanResult(connection.copy(source, destination))));
    }

    @Procedure
    @Description("apoc.redis.exists(uri, keys, {config}) | Execute the 'EXISTS keys' command")
    public Stream<LongResult> exists(
            @Name("uri") String uri,
            @Name("keys") List<Object> keys,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<BooleanResult> pexpire(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name("time") long time,
            @Name("isExpireAt") boolean isExpireAt,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
        return withConnection(
                uri, config, connection -> Stream.of(new BooleanResult(connection.pexpire(key, time, isExpireAt))));
    }

    @Procedure
    @Description("apoc.redis.persist(uri, key, {config}) | Execute the 'PERSIST key' command")
    public Stream<BooleanResult> persist(
            @Name("uri") String uri,
            @Name("key") Object key,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<ObjectResult> info(
            @Name("uri") String uri, @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
    ...
    public Stream<MapResult> configGet(
            @Name("uri") String uri,
    ...
    public Stream<ObjectResult> configSet(
            @Name("uri") String uri,
            @Name("parameter") String parameter,
            @Name("value") String value,
            @Name(value = "config", defaultValue = "{}") Map<String, Object> config) {
        return withConnection(
                uri, config, connection -> Stream.of(new ObjectResult(connection.configSet(parameter, value))));
    }
