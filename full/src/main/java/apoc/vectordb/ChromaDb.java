...
public class ChromaDb {
    ...
    public Stream<MapResult> createCollection(
        ...
        Map<String, Object> metadata = Map.of("hnsw:space", similarity, "size", size);
    ...
    public Stream<MapResult> upsert(
        ...
        Map<String, String> mapKeys =
                Map.of("id", "ids", "vector", "embeddings", "metadata", "metadatas", "text", "documents");
    ...
    public Stream<ListResult> delete(
            @Name("hostOrKey") String hostOrKey,
            @Name("collection") String collection,
    ...
    private Stream<EmbeddingResult> queryCommon(
        ...
        return getEmbeddingResultStream(apiConfig, procedureCallContext, tx, v -> listOfListsToMap((Map) v).stream());
    }
