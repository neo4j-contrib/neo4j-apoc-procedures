...
//@Testcontainers
public class HdfsContainerTest2 {
...
//    @Container
    ...
    private static void waitForNetwork(String networkName) throws Exception {
        for (int i = 0; i < 10; i++) {
            String networks = new ProcessBuilder("docker", "network", "ls", "--format", "{{.Name}}")
                    .start()
                    .inputReader()
                    .lines()
                    .reduce("", (a, b) -> a + "\n" + b);
        ...
        throw new RuntimeException("Network " + networkName + " not found after waiting");
    }
