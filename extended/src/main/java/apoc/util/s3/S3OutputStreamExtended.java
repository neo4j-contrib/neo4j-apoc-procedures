...
public class S3OutputStreamExtended extends OutputStream {
    ...
    S3OutputStreamExtended(@Nonnull AmazonS3 s3Client, @Nonnull String bucketName, @Nonnull String keyName) throws IOException {
