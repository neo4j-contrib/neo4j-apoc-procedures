...
public class S3AwsExtended {

    AmazonS3 s3Client;

    public S3AwsExtended(S3ParamsExtended s3Params, String region) {
        ...
        builder.withCredentials(credentialsProvider)
                .withClientConfiguration(S3URLConnectionExtended.buildClientConfig())
    ...
    public StreamConnectionExtended getS3AwsInputStream(S3ParamsExtended s3Params) {

        S3Object s3Object = s3Client.getObject(s3Params.getBucket(), s3Params.getKey());
        ObjectMetadata metadata = s3Object.getObjectMetadata();
        return new StreamConnectionExtended() {
            @Override
