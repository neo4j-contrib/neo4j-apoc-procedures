...
public class S3ParamsExtractorExtended {
    ...
    public static S3ParamsExtended extract(URL url) throws IllegalArgumentException {
        return extract(url.toString());
    }

    public static S3ParamsExtended extract(String url) throws IllegalArgumentException {
        ...
        if (uri.getUserInfo() != null) {
            ...
            Map<String, String> params = UtilExtended.getRequestParameter(uri.getQuery());
        ...
        return new S3ParamsExtended(accessKey, secretKey, sessionToken, endpoint, bucket, key, region);
    }
}
