...
import static apoc.util.DateFormatUtilExtended.ELASTIC_PATTERNS;
import static apoc.util.DateFormatUtilExtended.ISO_DURATION_PATTERNS;
...
public class DurationFormatUtilExtended {
