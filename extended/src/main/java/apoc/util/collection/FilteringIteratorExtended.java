 ...
 */
public class FilteringIteratorExtended<T> extends PrefetchingIteratorExtended<T> {
    private final Iterator<T> source;
    private final Predicate<T> predicate;

    public FilteringIteratorExtended(Iterator<T> source, Predicate<T> predicate) {
        this.source = source;
