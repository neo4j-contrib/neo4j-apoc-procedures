...
public class CompressionConfigExtended {
    ...
    public CompressionConfigExtended(Map<String, Object> config) {
        this(config, CompressionAlgoExtended.NONE.name());
    }

    public CompressionConfigExtended(Map<String, Object> config, String defaultCompression) {
