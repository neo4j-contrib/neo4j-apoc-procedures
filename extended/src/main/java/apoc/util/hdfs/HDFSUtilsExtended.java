...
public class HDFSUtilsExtended {

    private HDFSUtilsExtended() {}

    public static StreamConnectionExtended readFile(String fileName) throws IOException {
    ...
    public static StreamConnectionExtended readFile(URL url) throws IOException {
