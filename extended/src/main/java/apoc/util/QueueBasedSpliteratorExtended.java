 ...
 * @since 06.12.17
 */
public class QueueBasedSpliteratorExtended<T> implements Spliterator<T> {
    ...
    public QueueBasedSpliteratorExtended(
    ...
    public boolean tryAdvance(Consumer<? super T> action) {
        ...
        T element = QueueUtilExtended.take(queue, timeoutSeconds, () -> terminationGuard.check());
