...
public class ExportProgressInfoExtended implements ProgressInfo {
    ...
    public ExportProgressInfoExtended drain(StringWriter writer, ExportConfig config) {
        if (writer != null) {
            this.data = ExtendedUtil.getStringOrCompressedData(writer, config);
        }
        return this;
    }
