 ...
 * @since 16.03.16
 */
public class VirtualRelationshipExtended implements Relationship {
    ...
    public VirtualRelationshipExtended(Node startNode, Node endNode, RelationshipType type, Map<String, Object> props) {
        this(startNode, endNode, type);
        this.props.putAll(props);
    }

    public VirtualRelationshipExtended(Node startNode, Node endNode, RelationshipType type) {
    ...
    public VirtualRelationshipExtended(
    ...
    public static Relationship from(VirtualNodeExtended start, VirtualNodeExtended end, Relationship rel) {
        return new VirtualRelationshipExtended(start, end, rel.getType()).withProperties(rel.getAllProperties());
    }
    ...
    @Override
    public void delete() {
        if (getStartNode() instanceof VirtualNodeExtended) ((VirtualNodeExtended) getStartNode()).delete(this);
        if (getEndNode() instanceof VirtualNodeExtended) ((VirtualNodeExtended) getEndNode()).delete(this);
    }
