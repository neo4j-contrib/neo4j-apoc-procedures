...
public class Gexf {
    ...
    public Stream<ExportProgressInfoExtended> importGexf(
        ...
        ExportProgressInfoExtended result = Util.inThread(pools, () -> {
            ...
            ProgressReporter reporter = new ProgressReporter(null, null, new ExportProgressInfoExtended(file, source, "gexf"));
