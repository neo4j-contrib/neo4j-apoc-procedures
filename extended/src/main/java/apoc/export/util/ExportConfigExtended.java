...
import apoc.export.cypher.formatter.CypherFormatExtended;
 ...
 * @since 19.01.14
 */
public class ExportConfigExtended extends CompressionConfigExtended {
    ...
    public static final ExportConfigExtended EMPTY = new ExportConfigExtended(null);
    ...
    private ExportFormatExtended format;
    private CypherFormatExtended cypherFormat;
    ...
    public ExportFormatExtended getFormat() {
        return format;
    }
    ...
    public CypherFormatExtended getCypherFormat() {
        return cypherFormat;
    }
    ...
    public ExportConfigExtended(Map<String, Object> config) {
        this(config, ExportFormatExtended.CYPHER_SHELL);
    }

    public ExportConfigExtended(Map<String, Object> config, ExportFormatExtended exportFormat) {
        super(config);
        ...
        this.format = ExportFormatExtended.fromString((String) config.getOrDefault("format", exportFormat.getFormat()));
        this.cypherFormat = CypherFormatExtended.fromString((String) config.getOrDefault("cypherFormat", "create"));
        this.config = config;
    ...
    private void validate() {
        if (OptimizationType.UNWIND_BATCH_PARAMS.equals(this.optimizationType)
                && !ExportFormatExtended.CYPHER_SHELL.equals(this.format)) {
        ...
        if (!OptimizationType.NONE.equals(this.optimizationType)
                ...
                && !ExportFormatExtended.CSV.equals(this.format)) {
    ...
    public long getTimeoutSeconds() {
        return UtilExtended.toLong(config.getOrDefault("timeoutSeconds", 100));
    }
