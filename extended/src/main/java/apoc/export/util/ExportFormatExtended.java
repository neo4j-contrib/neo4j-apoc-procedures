 ...
 * @since 06-04-2017
 */
public enum ExportFormatExtended {
    ...
    ExportFormatExtended(String format, String commit, String begin, String schemaAwait, String indexAwait) {
        this.format = format;
        this.begin = begin;
        this.commit = commit;
    ...
    public static final ExportFormatExtended fromString(String format) {
        if (format != null && !format.isEmpty()) {
            for (ExportFormatExtended exportFormat : ExportFormatExtended.values()) {
