...
import static apoc.ExtendedApocConfig.APOC_MAX_DECOMPRESSION_RATIO;
import static apoc.ExtendedApocConfig.DEFAULT_MAX_DECOMPRESSION_RATIO;
import static apoc.ExtendedApocConfig.extendedApocConfig;

public class LimitedSizeInputStreamExtended extends InputStream {
    ...
    public static final int SIZE_MULTIPLIER =
            extendedApocConfig().getInt(APOC_MAX_DECOMPRESSION_RATIO, DEFAULT_MAX_DECOMPRESSION_RATIO);

    private final InputStream stream;
    private final long maxSize;
    private long total;

    public LimitedSizeInputStreamExtended(InputStream stream, long maxSize) {
        this.stream = stream;
    ...
    public static InputStream toLimitedIStream(InputStream stream, long total) {
        ...
        return new LimitedSizeInputStreamExtended(stream, total * SIZE_MULTIPLIER);
    }
}
