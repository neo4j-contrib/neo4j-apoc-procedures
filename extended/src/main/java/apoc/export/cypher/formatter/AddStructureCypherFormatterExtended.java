 ...
 * @since 16-06-2017
 */
public class AddStructureCypherFormatterExtended extends AbstractCypherFormatterExtended implements CypherFormatterExtended {
    ...
    public String statementForNode(
        ...
        return super.mergeStatementForNode(
                CypherFormatExtended.ADD_STRUCTURE, node, uniqueConstraints, indexedProperties, indexNames);
    }
