...
import static apoc.export.cypher.formatter.CypherFormatterUtilsExtended.cypherNode;
import static apoc.util.UtilExtended.quote;

public class DatabaseSubGraphExtended implements SubGraphExtended {
    ...
    public static SubGraphExtended optimizedForCount(Transaction transaction, KernelTransaction kernelTransaction) {
    ...
    public Iterable<IndexDefinition> getIndexes() {
        return ExtendedUtil.getIndexes(transaction);
    }
    ...
    public Iterable<IndexDefinition> getIndexes(Label label) {
        return ExtendedUtil.getIndexes(transaction, label);
    }

    @Override
    public Iterable<IndexDefinition> getIndexes(RelationshipType type) {
        return ExtendedUtil.getIndexes(transaction, type);
    }
