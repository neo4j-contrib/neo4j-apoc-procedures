...
| apoc.util.fail(message,[params]) | raises exception with the given message
| apoc.util.assert(predicate, message, [params]) | raises exception with given message if predicate evaluates to false
|===
