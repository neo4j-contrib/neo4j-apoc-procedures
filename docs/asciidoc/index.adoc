...
* <<nodes-relationships>> -- A detailed guide to node, relationship, and path functions and procedures.
...
* <<operational>> -- A detailed guide to operational procedures, like monitoring and logging.
