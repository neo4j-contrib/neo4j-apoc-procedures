...
include::installation/neo4j-desktop.adoc[tags=install-desktop,leveloffset=2]


=== Neo4j Server

include::installation/neo4j-server.adoc[tags=install,leveloffset=2]
...
include::installation/docker.adoc[tags=docker,leveloffset=1]


=== Restricted procedures/functions

include::installation/restricted.adoc[tags=warnings,leveloffset=1]