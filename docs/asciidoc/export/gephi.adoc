...
* <<export-gephi-install-plugin, Installing the plugin>>
* <<export-gephi-available-procedures, Available Procedures>>
* <<export-gephi-format, Export Format>>
* <<export-gephi-examples, Examples>>
...
It can also be configured by adding the following to `neo4j.conf`:
