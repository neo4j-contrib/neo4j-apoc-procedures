...
[abstract]
--
This chapter describes graph refactoring procedures in the APOC library.
--
...
include::graph-refactor/clone-nodes.adoc[leveloffset=2]

include::graph-refactor/clone-subgraph.adoc[leveloffset=2]

include::graph-refactor/merge-nodes.adoc[leveloffset=2]

include::graph-refactor/redirect-relationship.adoc[leveloffset=2]

include::graph-refactor/invert-relationship.adoc[leveloffset=2]

include::graph-refactor/set-relationship-type.adoc[leveloffset=2]

include::graph-refactor/extract-node-from-relationship.adoc[leveloffset=2]

include::graph-refactor/collapse-node-to-relationship.adoc[leveloffset=2]

include::graph-refactor/normalize-boolean.adoc[leveloffset=2]

include::graph-refactor/categorize.adoc[leveloffset=2]

include::graph-refactor/property-value-label.adoc[leveloffset=2]

include::graph-refactor/rename-label-type-property.adoc[leveloffset=2]
