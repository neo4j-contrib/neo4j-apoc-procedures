...
image::apoc.rename-initial.png[scaledwidth="100%"]
...
image::apoc.rename-update-node-labels.png[scaledwidth="100%"]
...
image::apoc.rename-rename-rel-type.png[scaledwidth="100%"]
