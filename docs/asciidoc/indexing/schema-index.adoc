...
image::{img}/apoc.schema.assert.index.png[scaledwidth="100%"]
...
image::{img}/apoc.schema.assert.constraint.png[scaledwidth="100%"]
...
image::{img}/apoc.schema.assert.drop.png[scaledwidth="100%"]
...
image::{img}/apoc.schema.nodes.png[scaledwidth="100%"]
...
image::{img}/apoc.schema.relationships.png[scaledwidth="100%"]
...
image::{img}/apoc.schema.node.indexExists.png[scaledwidth="100%"]
...
image::{img}/apoc.schema.node.constraintExists.png[scaledwidth="100%"]
...
image::{img}/apoc.schema.relationship.constraintExists.png[scaledwidth="100%"]