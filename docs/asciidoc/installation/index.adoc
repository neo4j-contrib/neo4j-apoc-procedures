...
include::neo4j-desktop.adoc[tags=install-desktop,leveloffset=2]


=== Neo4j Server

include::neo4j-server.adoc[tags=install,leveloffset=2]
...
include::docker.adoc[tags=docker,leveloffset=1]


=== Restricted procedures/functions

include::restricted.adoc[tags=warnings,leveloffset=1]