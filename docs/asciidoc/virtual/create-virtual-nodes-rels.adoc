...
image::{img}/apoc.create.vRelationshipAndvNode.png[scaledwidth="100%"]

[NOTE]
Virtual nodes and virtual relationships have always a negative id

image::{img}/vNodeId.png[scaledwidth="100%"]
...
image::{img}/apoc.create.vPattern.png[scaledwidth="100%"]
...
image::{img}/apoc.create.vPatternLabels.png[scaledwidth="100%"]
...
image::{img}/apoc.create.vPatternFull.png[scaledwidth="100%"]
...
image::{img}/apoc.create.vPatternFullTwo.png[scaledwidth="100%"]