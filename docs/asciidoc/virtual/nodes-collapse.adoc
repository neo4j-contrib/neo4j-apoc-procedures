...
image::{img}/apoc.nodes.collapse_1.png[scaledwidth="100%"]
...
image::{img}/apoc.nodes.collapse_2.png[scaledwidth="100%"]

With this dataset we have:

image::{img}/apoc.nodes.collapse_3.png[scaledwidth="100%"]
...
image::{img}/apoc.nodes.collapse_4.png[scaledwidth="100%"]
