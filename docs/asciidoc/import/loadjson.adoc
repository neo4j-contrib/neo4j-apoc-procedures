...
[abstract]
--
This chapter describes procedures that can be used to import JSON data from web APIs or files.
--
...
image::{img}/apoc.load.json.so.png[scaledwidth="100%"]
...
image::{img}/apoc.load.json-so-result.png[scaledwidth="100%"]
