...
|===
include::../../../build/generated-documentation/apoc.load.json-lite.csv[]
|===
...
[separator=¦,opts=header,cols="1m"]
|===
include::../../../build/generated-documentation/apoc.load.jsonParams-lite.csv[]
|===
...
[separator=¦,opts=header,cols="1m"]
|===
include::../../../build/generated-documentation/apoc.load.jsonArray-lite.csv[]
|===
...
[separator=¦,opts=header,cols="1m"]
|===
include::../../../build/generated-documentation/apoc.import.json-lite.csv[]
|===
...
[NOTE]
--
Since this is a rather long url string, we can simplify the syntax by configuring aliases in the `conf/apoc.conf`:
