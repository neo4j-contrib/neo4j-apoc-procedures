...
[abstract]
--
This section describes procedures that can be used to import data from CSV files.
--
...
image::{img}/apoc.load.xls.png[scaledwidth="100%"]
...
image::{img}/apoc.load.xls_1.png[scaledwidth="100%"]
...
image::{img}/apoc.load.xls_2.png[scaledwidth="100%"]
...
image::{img}/apoc.load.xls_3.png[scaledwidth="100%"]