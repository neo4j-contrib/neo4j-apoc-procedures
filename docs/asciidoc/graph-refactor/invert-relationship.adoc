...
image::{img}/apoc.refactor.invert.dataset.png[scaledwidth="100%"]
...
image::{img}/apoc.refactor.invert.call.png[scaledwidth="100%"]

image::{img}/apoc.refactor.invert.png[scaledwidth="100%"]