...
image::{img}/apoc.refactor.cloneNodes.dataset.png[scaledwidth="100%"]
...
image::{img}/apoc.refactor.cloneNodes.png[scaledwidth="100%"]
...
image::{img}/apoc.refactor.cloneNodesWithRelationships.dataset.png[scaledwidth="100%"]
...
image::{img}/apoc.refactor.cloneNodesWithRelationships.png[scaledwidth="100%"]