...
Note this utility requires to have the link:https://mvnrepository.com/artifact/org.apache.directory.api/apache-ldap-api/2.0.1[Apache LDAP API 2.0] library to be placed the plugin directory.
