...
include::example$generated-documentation/apoc.schema.node.compareIndexesAndConstraints.adoc[]
include::example$generated-documentation/apoc.schema.relationship.constraintExists.adoc[]
include::example$generated-documentation/apoc.schema.relationship.compareIndexesAndConstraints.adoc[]
