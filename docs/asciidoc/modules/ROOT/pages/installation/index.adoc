[[installation]]
= Installation
:page-custom-canonical: https://neo4j.com/docs/apoc/current/installation/
...
| http://github.com/neo4j-contrib/neo4j-apoc-procedures/releases/4.2.0.1[4.2.0.1^] | 4.2.3 (4.2.x)
| http://github.com/neo4j-contrib/neo4j-apoc-procedures/releases/4.1.0.6[4.1.0.6^] | 4.1.6 (4.1.x)
| http://github.com/neo4j-contrib/neo4j-apoc-procedures/releases/4.0.0.18[4.0.0.18^] | 4.0.11 (4.0.x)
