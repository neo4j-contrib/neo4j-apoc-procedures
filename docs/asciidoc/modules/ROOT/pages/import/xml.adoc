...
|===
include::example$generated-documentation/apoc.load.xml.csv[]
include::example$generated-documentation/apoc.xml.parse.csv[lines=2:]
include::example$generated-documentation/apoc.import.xml.csv[lines=2:]
|===
