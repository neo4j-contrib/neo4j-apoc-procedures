...
|===
include::generated-documentation/apoc.load.xml.csv[]
include::generated-documentation/apoc.xml.parse.csv[lines=2:]
include::generated-documentation/apoc.import.xml.csv[lines=2:]
|===
...
|===
include::generated-documentation/apoc.load.xml-lite.csv[]
|===
...
[separator=¦,opts=header,cols="1m"]
|===
include::generated-documentation/apoc.xml.parse-lite.csv[]
|===
...
[separator=¦,opts=header,cols="1m"]
|===
include::generated-documentation/apoc.import.xml-lite.csv[]
|===
