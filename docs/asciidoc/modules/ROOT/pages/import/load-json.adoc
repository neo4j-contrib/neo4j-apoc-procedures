...
|===
include::generated-documentation/apoc.load.json.csv[]
include::generated-documentation/apoc.load.jsonParams.csv[lines=2:]
include::generated-documentation/apoc.load.jsonArray.csv[lines=2:]
include::generated-documentation/apoc.import.json.csv[lines=2:]
|===
...
|===
include::generated-documentation/apoc.load.json-lite.csv[]
|===
...
[separator=¦,opts=header,cols="1m"]
|===
include::generated-documentation/apoc.load.jsonParams-lite.csv[]
|===
...
[separator=¦,opts=header,cols="1m"]
|===
include::generated-documentation/apoc.load.jsonArray-lite.csv[]
|===

[[load-json-available-procedures-apoc.import.json]]
=== `apoc.import.json`

This procedure can be used to import JSON files created by the <<export-json, Export JSON>> procedures.

[separator=¦,opts=header,cols="1m"]
|===
include::generated-documentation/apoc.import.json-lite.csv[]
|===
