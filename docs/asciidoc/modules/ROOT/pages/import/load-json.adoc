...
|===
include::example$generated-documentation/apoc.load.json.csv[]
include::example$generated-documentation/apoc.load.jsonParams.csv[lines=2:]
include::example$generated-documentation/apoc.load.jsonArray.csv[lines=2:]
include::example$generated-documentation/apoc.import.json.csv[lines=2:]
|===
