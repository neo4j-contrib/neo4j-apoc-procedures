...
|===
include::generated-documentation/apoc.cypher.doIt.csv[]
include::generated-documentation/apoc.cypher.run.csv[lines=2:]
include::generated-documentation/apoc.cypher.runMany.csv[lines=2:]
include::generated-documentation/apoc.cypher.parallel.csv[lines=2:]
include::generated-documentation/apoc.cypher.parallel2.csv[lines=2:]
include::generated-documentation/apoc.cypher.mapParallel.csv[lines=2:]
include::generated-documentation/apoc.cypher.mapParallel2.csv[lines=2:]
include::generated-documentation/apoc.cypher.runFirstColumn.csv[lines=2:]
include::generated-documentation/apoc.cypher.runFirstColumnMany.csv[lines=2:]
include::generated-documentation/apoc.cypher.runFirstColumnSingle.csv[lines=2:]
|===
