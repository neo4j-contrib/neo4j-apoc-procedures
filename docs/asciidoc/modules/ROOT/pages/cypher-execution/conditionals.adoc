...
|===
include::generated-documentation/apoc.when.csv[]
include::generated-documentation/apoc.do.when.csv[lines=2:]
include::generated-documentation/apoc.case.csv[lines=2:]
include::generated-documentation/apoc.do.case.csv[lines=2:]
|===
...
|===
include::generated-documentation/apoc.when-lite.csv[]
include::generated-documentation/apoc.do.when-lite.csv[lines=2:]
|===
...
[separator=¦,opts=header]
|===
include::generated-documentation/apoc.case-lite.csv[]
include::generated-documentation/apoc.do.case-lite.csv[lines=2:]
|===
