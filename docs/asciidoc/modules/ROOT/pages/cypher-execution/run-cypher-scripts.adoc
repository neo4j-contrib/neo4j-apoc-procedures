...
include::example$generated-documentation/apoc.cypher.runReadFile.adoc[]
include::example$generated-documentation/apoc.cypher.runReadFiles.adoc[]
...
* `apoc.cypher.runReadFile(file or url,[\{config}])`
* `apoc.cypher.runReadFiles([files or urls],[\{config})])`
