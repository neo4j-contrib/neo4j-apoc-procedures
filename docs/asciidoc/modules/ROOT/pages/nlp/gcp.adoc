...
|===
include::generated-documentation/apoc.nlp.gcp.entities.csv[]
include::generated-documentation/apoc.nlp.gcp.classify.csv[lines=2..3]
|===
...
|===
include::generated-documentation/apoc.nlp.gcp.entities.stream-lite.csv[]
include::generated-documentation/apoc.nlp.gcp.entities.graph-lite.csv[lines=2;]
|===
...
[separator=¦,opts=header,cols="1"]
|===
include::generated-documentation/apoc.nlp.gcp.classify.stream-lite.csv[]
include::generated-documentation/apoc.nlp.gcp.classify.graph-lite.csv[lines=2;]
|===
...
Batching requests to the GCP API and the processing of results can be done using xref:graph-updates/periodic-iterate.adoc[].
