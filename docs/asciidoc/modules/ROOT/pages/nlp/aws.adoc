...
:page-custom-canonical: https://neo4j.com/labs/apoc/5/nlp/aws/
...
|===
include::example$generated-documentation/apoc.nlp.aws.entities.csv[]
include::example$generated-documentation/apoc.nlp.aws.keyPhrases.csv[lines=2;3]
include::example$generated-documentation/apoc.nlp.aws.sentiment.csv[lines=2;3]
|===
