...
:page-custom-canonical: https://neo4j.com/labs/apoc/5/nlp/azure/
...
|===
include::example$generated-documentation/apoc.nlp.azure.entities.csv[]
include::example$generated-documentation/apoc.nlp.azure.keyPhrases.csv[lines=2;3]
include::example$generated-documentation/apoc.nlp.azure.sentiment.csv[lines=2;3]
|===
