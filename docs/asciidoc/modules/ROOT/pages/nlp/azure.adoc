...
For better results, make sure that your text is one of the https://docs.microsoft.com/en-us/azure/cognitive-services/text-analytics/language-support?tabs=named-entity-recognition
[supported languages by Cognitive Services].
====
