...
[NOTE]
====
If you need to manipulate Date object types into other formats, see <<temporal-conversions>>.
====
...
|===
include::generated-documentation/apoc.date.add.csv[]
include::generated-documentation/apoc.date.convert.csv[lines=2:]
include::generated-documentation/apoc.date.convertFormat.csv[lines=2:]
include::generated-documentation/apoc.date.currentTimestamp.csv[lines=2:]
include::generated-documentation/apoc.date.field.csv[lines=2:]
include::generated-documentation/apoc.date.fields.csv[lines=2:]
include::generated-documentation/apoc.date.format.csv[lines=2:]
include::generated-documentation/apoc.date.fromISO8601.csv[lines=2:]
include::generated-documentation/apoc.date.parse.csv[lines=2:]
include::generated-documentation/apoc.date.parseAsZonedDateTime.csv[lines=2:]
include::generated-documentation/apoc.date.systemTimezone.csv[lines=2:]
include::generated-documentation/apoc.date.toISO8601.csv[lines=2:]
include::generated-documentation/apoc.date.toYears.csv[lines=2:]
|===
...
|===
include::generated-documentation/apoc.date.add-lite.csv[]
|===
...
[separator=¦,opts=header,cols="1m"]
|===
include::generated-documentation/apoc.date.convert-lite.csv[]
|===
...
[separator=¦,opts=header,cols="1m"]
|===
include::generated-documentation/apoc.date.convertFormat-lite.csv[]
|===
...
[separator=¦,opts=header,cols="1m"]
|===
include::generated-documentation/apoc.date.currentTimestamp-lite.csv[]
|===
...
[separator=¦,opts=header,cols="1m"]
|===
include::generated-documentation/apoc.date.field-lite.csv[]
|===
...
[separator=¦,opts=header,cols="1m"]
|===
include::generated-documentation/apoc.date.fields-lite.csv[]
|===
...
[separator=¦,opts=header,cols="1m"]
|===
include::generated-documentation/apoc.date.format-lite.csv[]
|===
...
[separator=¦,opts=header,cols="1m"]
|===
include::generated-documentation/apoc.date.parse-lite.csv[]
|===
...
[separator=¦,opts=header,cols="1m"]
|===
include::generated-documentation/apoc.date.systemTimezone-lite.csv[]
|===
...
[separator=¦,opts=header,cols="1m"]
|===
include::generated-documentation/apoc.date.toISO8601-lite.csv[]
|===
