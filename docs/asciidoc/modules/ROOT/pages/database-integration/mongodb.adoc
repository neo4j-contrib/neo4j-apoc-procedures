...
// TODO - SCRIVERE CHE ALCUNE SONO DEPRECATE
...
== Field description
 ...
 - `useExtendedJson`: (false|true): support query params as Extended JSON. See https://github.com/mongodb/specifications/blob/master/source/extended-json.rst[Extended Json Specification]
