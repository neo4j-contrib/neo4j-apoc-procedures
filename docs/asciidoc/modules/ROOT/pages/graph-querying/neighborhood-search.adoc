...
* <<neighborhood-search-available-procedures, Available Procedures>>
* <<neighborhood-search-rel-filters, Relationship Filters>>
* <<neighborhood-search-examples, Examples>>
** <<neighborhood-search-specified-hop-count, Find neighbors at specified hop count>>
** <<neighborhood-search-specified-hop-counts, Find neighbors at specified hop counts>>
** <<neighborhood-search-up-to-hop-count, Find neighbors up to specified hop count>>
...
|===
include::example$generated-documentation/apoc.neighbors.csv[]
include::example$generated-documentation/apoc.neighbors.athop.csv[lines=2]
include::example$generated-documentation/apoc.neighbors.byhop.csv[lines=2]
include::example$generated-documentation/apoc.neighbors.tohop.csv[lines=2]
|===
...
We could even <<map-functions, turn that list of numbers into a map>> with the key being the number of hops and the value the neighborhood size.
