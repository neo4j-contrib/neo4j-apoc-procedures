...
|===
include::generated-documentation/apoc.path.create.csv[]
include::generated-documentation/apoc.path.combine.csv[lines=2:]
include::generated-documentation/apoc.path.slice.csv[lines=2:]
include::generated-documentation/apoc.path.elements.csv[lines=2:]
|===
