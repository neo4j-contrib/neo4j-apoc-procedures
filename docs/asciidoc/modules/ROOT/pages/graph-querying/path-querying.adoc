...
|===
include::example$generated-documentation/apoc.path.create.csv[]
include::example$generated-documentation/apoc.path.combine.csv[lines=2:]
include::example$generated-documentation/apoc.path.slice.csv[lines=2:]
include::example$generated-documentation/apoc.path.elements.csv[lines=2:]
|===
