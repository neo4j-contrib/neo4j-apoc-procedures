...
For a more basic version of the algorithm where fine grained control over traversals isn't required, see <<path-expander-paths>>.
...
|===
include::example$generated-documentation/apoc.path.expandConfig.csv[]
|===
...
include::expand-config-sample-graph.adoc[]
