...
This procedure has the same behaviour as <<path-expander-paths-config>> with the config `uniqueness: "NODE_GLOBAL"`.
...
|===
include::example$generated-documentation/apoc.path.spanningTree.csv[]
|===
