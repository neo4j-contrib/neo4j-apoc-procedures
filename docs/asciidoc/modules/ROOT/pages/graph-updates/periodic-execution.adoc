...
|===
include::generated-documentation/apoc.periodic.iterate.csv[]
include::generated-documentation/apoc.periodic.commit.csv[lines=2:]
include::generated-documentation/apoc.periodic.rock_n_roll.csv[lines=2:]
|===
