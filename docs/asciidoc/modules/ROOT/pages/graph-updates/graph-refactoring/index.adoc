...
include::clone-nodes.adoc[leveloffset=3]

include::clone-subgraph.adoc[leveloffset=3]

include::merge-nodes.adoc[leveloffset=3]

include::redirect-relationship.adoc[leveloffset=3]

include::invert-relationship.adoc[leveloffset=3]

include::set-relationship-type.adoc[leveloffset=3]

include::extract-node-from-relationship.adoc[leveloffset=3]

include::collapse-node-to-relationship.adoc[leveloffset=3]

include::normalize-boolean.adoc[leveloffset=3]

include::categorize.adoc[leveloffset=3]

include::property-value-label.adoc[leveloffset=3]

include::rename-label-type-property.adoc[leveloffset=3]
