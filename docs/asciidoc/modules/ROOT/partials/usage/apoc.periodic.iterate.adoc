...
[source,cypher]
----
SHOW TRANSACTIONS YIELD statusDetails, currentQuery WHERE currentQuery STARTS WITH 'cypher runtime=slotted <statement returning items>' RETURN statusDetails
----
