...
[source,cypher]
----
CALL apoc.load.xml('largeFile.xml', '/graphml/*', {})
----
...
| {"_children":[{"_type":"data","_text":"ACTED_IN","key":"label"}],"_type":"edge","id":"e18","label":"ACTED_IN","source":"n4","target":"n10"}
...
[source,cypher]
----
CALL apoc.load.xml('largeFile.xml', '/graphml/node', {})
----
