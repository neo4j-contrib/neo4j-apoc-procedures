...
|===
| rel                                      | relId
| [:SIMILAR_LEVEL {level: "intermediate"}] | -1
| [:SIMILAR_LEVEL {level: "advanced"}]     | -2
| [:SIMILAR_LEVEL {level: "beginner"}]     | -3
| [:SIMILAR_LEVEL {level: "intermediate"}] | -4
| [:SIMILAR_LEVEL {level: "beginner"}]     | -5
| [:SIMILAR_LEVEL {level: "advanced"}]     | -6
|===