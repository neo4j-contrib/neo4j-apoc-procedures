...
| https://github.com/neo4j-contrib/neo4j-apoc-procedures/releases/5.11.1[5.11.1^] | 5.11.0 (5.11.x)
...
| https://github.com/neo4j-contrib/neo4j-apoc-procedures/releases/4.4.0.20[4.4.0.20^] | 4.4.0 (4.4.x)
|===
