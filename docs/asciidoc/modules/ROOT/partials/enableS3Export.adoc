...
* httpclient-4.5.4.jar (https://mvnrepository.com/artifact/org.apache.httpcomponents/httpclient/4.5.4)
* httpcore-4.4.8.jar (https://mvnrepository.com/artifact/org.apache.httpcomponents/httpcore/4.4.8)
