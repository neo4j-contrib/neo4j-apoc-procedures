...
==== Sequences of relationship types and node labels

We can specify sequences of relationship types by comma separating the values passed to `relationshipFilter`, and sequences of node labels by comma separating values passed to `labelFilter`.

If we start from the Praveena node and want to find the paths that contain alternating `Field` and `DevRel` nodes, we can specify a label filter of `"+Field,+DevRel"`.
...
But what if we don't want to specify both labels, but instead want to find paths where a node doesn't have a label?
To find paths that contain alternating `Field` and not `Field` nodes, we can specify a label filter of `"+Field,-Field"`.

.The following returns the paths of 2 to 4 hops from Praveena where the nodes alternate between having the `Field` label and not having the `Field` label
[source,cypher]
----
MATCH (p:Person {name: "Praveena"})
CALL apoc.path.expandConfig(p, {
...
If we aren't interested in seeing the relationships, we can use the `nodes` function to just return the nodes:
...
|===
| nodes
| [(:Person:Engineering {name: "Praveena"}), (:Person:Field {name: "Joe"}), (:Person:Engineering {name: "Zhen"})]                                                                    | 2
| [(:Person:Engineering {name: "Praveena"}), (:Person:Field {name: "Joe"}), (:Person:Engineering {name: "Praveena"})]                                                                | 2
| [(:Person:Engineering {name: "Praveena"}), (:Person:Field {name: "Joe"}), (:Person:DevRel {name: "Mark"})]                                                                         | 2
| [(:Person:Engineering {name: "Praveena"}), (:Person:Field {name: "Joe"}), (:Person:Product {name: "Alicia"})]                                                                      | 2
| [(:Person:Engineering {name: "Praveena"}), (:Person:Field {name: "Joe"}), (:Person:Engineering {name: "Zhen"})]                                                                    | 2
| [(:Person:Engineering {name: "Praveena"}), (:Person:Field {name: "Joe"}), (:Person:Engineering {name: "Praveena"})]                                                                | 2
| [(:Person:Engineering {name: "Praveena"}), (:Person:Field {name: "Joe"}), (:Person:DevRel {name: "Mark"})]                                                                         | 2
| [(:Person:Engineering {name: "Praveena"}), (:Person:Field {name: "Joe"}), (:Person:Product {name: "Alicia"})]                                                                      | 2
| [(:Person:Engineering {name: "Praveena"}), (:Person:Field {name: "Joe"}), (:Person:Engineering {name: "Zhen"}), (:Person:Field {name: "Stefan"})]                                  | 3
| [(:Person:Engineering {name: "Praveena"}), (:Person:Field {name: "Joe"}), (:Person:DevRel {name: "Mark"}), (:Person:Field {name: "Stefan"})]                                       | 3
| [(:Person:Engineering {name: "Praveena"}), (:Person:Field {name: "Joe"}), (:Person:Engineering {name: "Zhen"}), (:Person:Field {name: "Stefan"})]                                  | 3
| [(:Person:Engineering {name: "Praveena"}), (:Person:Field {name: "Joe"}), (:Person:DevRel {name: "Mark"}), (:Person:Field {name: "Stefan"})]                                       | 3
| [(:Person:Engineering {name: "Praveena"}), (:Person:Field {name: "Joe"}), (:Person:Engineering {name: "Zhen"}), (:Person:Field {name: "Stefan"}), (:Person:DevRel {name: "Mark"})] | 4
| [(:Person:Engineering {name: "Praveena"}), (:Person:Field {name: "Joe"}), (:Person:DevRel {name: "Mark"}), (:Person:Field {name: "Stefan"}), (:Person:Engineering {name: "Zhen"})] | 4
| [(:Person:Engineering {name: "Praveena"}), (:Person:Field {name: "Joe"}), (:Person:Engineering {name: "Zhen"}), (:Person:Field {name: "Stefan"}), (:Person:DevRel {name: "Mark"})] | 4
| [(:Person:Engineering {name: "Praveena"}), (:Person:Field {name: "Joe"}), (:Person:DevRel {name: "Mark"}), (:Person:Field {name: "Stefan"}), (:Person:Engineering {name: "Zhen"})] | 4
|===
...
//CALL apoc.path.expandConfig(k, {
//    relationshipFilter:'ACTED_IN|PRODUCED|DIRECTED',
//    labelFilter:'/Western',
