...
|===
| name | type | default | description
| salienceCutoff | Double | 0.0 | Lower limit for the salience score of an entity to be present in the graph. Value must be between 0 and 1.
...
|===
| name | type | default | description
| confidenceCutoff | Double | 0.0 | Lower limit for the confidence score of a category to be present in the graph. Value must be between 0 and 1.
