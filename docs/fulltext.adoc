...
| analyzer | classnames | list of classname of lucene analyzer to be used for this index
...
CALL apoc.index.addAllNodes('locations',{
  Person:  ["address"],
  Address: ["address"]}, {analyzer:["EnglishAnalizer","RussianAnalizer","ThaiAnalyzer"]})
----
