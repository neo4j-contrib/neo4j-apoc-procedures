...
image::{img}/postgres.describe.jpg[width=800]

image::{img}/postgres.count.jpg[width=600]
...
image::{img}/apoc.load.postgres.count.jpg[width=800]
...
image::{img}/apoc.show.record.jpg[width=800]
...
image::{img}/apoc.schema.assert.jpg[width=800]
...
image::{img}/create.node.postgres.data.jpg[width=800]
...
image::{img}/oracle.schema.jpg[width=800]

image::{img}/oracle.count.jpg[width=600]
...
image::{img}/apoc.oracle.count.jpg[width=800]
update_load_jdbc_doc
Let’s create some indexes and constraints, note that other indexes and constraints will be dropped by this.
...
image::{img}/appoc.schema.oracle.assert.jpg[width=800]
...
CREATE (t)-[:LIVE]->(g);
----
image::{img}/apoc.oracle.node.create.jpg[width=800]
