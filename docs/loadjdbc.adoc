...
│row                                                                                                     │
╞════════════════════════════════════════════════════════════════════════════════════════════════════════╡
│{name: ANURAG SRIVASTAVA, age: 24, salary: 20000, id: 1, address: NEW DELHI              }              │
├────────────────────────────────────────────────────────────────────────────────────────────────────────┤
│{name: SHIVANSH SRIVASTAVA, age: 22, salary: 19000, id: 2, address: NEW DELHI            }              │
├────────────────────────────────────────────────────────────────────────────────────────────────────────┤
│{name: SANDY, age: 26, salary: 21000, id: 3, address: JODHPUR                            }              │
├────────────────────────────────────────────────────────────────────────────────────────────────────────┤
│{name: MANISH, age: 26, salary: 20000, id: 4, address: NEW DELHI                         }              │
└────────────────────────────────────────────────────────────────────────────────────────────────────────┘
----

Create data from query results.
----
CALL apoc.load.jdbc('jdbc:postgresql://localhost:5432/testdb?user=postgres&password=postgres','employee_details') yield row
CREATE (t:Employee {id:row.id, name:row.name, age:row.age, address:row.address, salary:row.salary});
----

----
Added 50 labels, created 50 nodes, set 250 properties, statement executed in 217 ms.
----
...
│row                                                                           │
╞══════════════════════════════════════════════════════════════════════════════╡
│{ADDRESS: NEW DELHI, ID: 1, NAME: ANURAG, AGE: 23, SALARY: 25000}             │
├──────────────────────────────────────────────────────────────────────────────┤
│{ADDRESS: NEW DELHI, ID: 2, NAME: SHIVANSH SRIVASTAVA, AGE: 22, SALARY: 19000}│
├──────────────────────────────────────────────────────────────────────────────┤
│{ADDRESS: JODHPUR, ID: 3, NAME: SANDY, AGE: 26, SALARY: 21000}                │
├──────────────────────────────────────────────────────────────────────────────┤
│{ADDRESS: NEW DELHI, ID: 4, NAME: MANISH, AGE: 26, SALARY: 20000}             │
├──────────────────────────────────────────────────────────────────────────────┤
│{ADDRESS: NEW DELHI, ID: 5, NAME: HARMEET, AGE: 26, SALARY: 21000}            │
└──────────────────────────────────────────────────────────────────────────────┘
----
...
----
CALL apoc.load.jdbc('oracle_url','employee_details') yield row
CREATE (t:EMPINFO {id:row.ID, name:row.NAME, age:row.AGE, salary:row.SALARY, address: row.ADDRESS})
----

----
Added 50 labels, created 50 nodes, set 250 properties, statement executed in 936 ms.
----
