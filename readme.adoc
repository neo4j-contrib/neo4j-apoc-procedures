...
Since apoc code relies on Neo4j internal API you need to be careful to pick the right apoc version for your neo4j instance.

Any version to be released in future will use a different versioning scheme: `<neo4j-version>.<apoc>` version.


|===
|apoc version |compliant neo4j version
|1.1.0 | 3.0.0 - 3.0.3
|1.0.0 | 3.0.0 - 3.0.3
|===
