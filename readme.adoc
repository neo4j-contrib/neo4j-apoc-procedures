...
[NOTE]
Please note that about 70 procedures have been turned into user defined functions, this includes, `apoc.date.* apoc.number.*, apoc.coll.*, apoc.map.*` and some more packages. 
See: https://github.com/neo4j-contrib/neo4j-apoc-procedures/issues/1 4
