...
| call apoc.search.nodeReduced(LabelPropertyMap, searchType: EXACT \| CONTAINS \| STARTS WITH \| ENDS WITH, searchValue ) yield id as <identifier>, labels as <identifier>, values as <identifier> | A merged set of 'reduced' Node information will be returned.
