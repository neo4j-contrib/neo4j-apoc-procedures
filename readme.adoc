...
| apoc.monitor.lock(minWaitTime long) | db locking information such as avertedDeadLocks, lockCount, contendedLockCount and contendedLocks etc.
...
Provides a wrapper around the java bitwise operations.
|===
| call apoc.bitwise.cmp(a long, "operation", b long ) yield value as <identifier> 
|===

examples
|===
| operator | name | example | result 
| a & b | AND | call apoc.bitwise.cmp(60,"&",13) | 12 
| a \| b | OR | call apoc.bitwise.cmp(60,"\|",13) | 61 
| a ^ b | XOR | call apoc.bitwise.cmp(60,"&",13) | 49
| ~a | NOT | call apoc.bitwise.cmp(60,"&",0) | -61
| a << b | LEFT SHIFT | call apoc.bitwise.cmp(60,"<<",2) | 240
| a >> b | RIGHT SHIFT | call apoc.bitwise.cmp(60,">>",2) | 15 
| a >>> b | UNSIGNED RIGHT SHIFT | call apoc.bitwise.cmp(60,">>>",2) | 15 
|===
