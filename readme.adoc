...
image::{img}/apoc-help-apoc.jpg[width=400,float=right]
...
image::{img}/apoc.index.nodes-with-score.jpg[float=right,width=400]
...
image::{img}/apoc.meta.graph.jpg[float=right,width=400]
...
image::{img}/apoc-jdbc-northwind-load.jpg[width=400,float=right]
