...
| call apoc.search.nodeAllReduced(LabelPropertyMap, searchType: EXACT \| CONTAINS \| STARTS WITH \| ENDS WITH, searchValue ) yield node as <identifier> |  All the found 'reduced' Node information will be returned.
|===
