...
The APOC library consists of a large range of procedures and functions to help with different tasks in areas like data integration, graph algorithms or data conversion.

As of 5.0, APOC has been split into two separate repositories. One being the main, officially supported, https://github.com/neo4j/apoc[APOC package^],
the other being this one, APOC Extended, containing additional functions and procedures.
// end::intro-text[]
