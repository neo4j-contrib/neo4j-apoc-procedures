...
public class UpdateStructureCypherFormatter extends AbstractCypherFormatter implements CypherFormatter {
    ...
    public String statementForRelationship(
        ...
        return super.mergeStatementForRelationship(
                CypherFormat.UPDATE_STRUCTURE, relationship, uniqueConstraints, indexedProperties, exportConfig);
    }
    ...
    public String statementForConstraint(
            String label, Iterable<String> key, ConstraintType type, boolean ifNotExists, String name) {
        return "";
    }
