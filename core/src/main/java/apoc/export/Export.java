...
public class Export {
    ...
    public Stream<ExportCypher.DataProgressInfo> cypherAll(
            @Name("file") String fileName, @Name("config") Map<String, Object> config) throws Exception {
    ...
    public Stream<ExportCypher.DataProgressInfo> cypherData(
    ...
    public Stream<ExportCypher.DataProgressInfo> cypherGraph(
    ...
    public Stream<ExportCypher.DataProgressInfo> cypherQuery(
