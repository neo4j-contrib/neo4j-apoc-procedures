...
public class Graphs {
    ...
    public Stream<VirtualGraph> fromData(
            ...
            @Name("relationships") List<Relationship> relationships,
    ...
    public Stream<VirtualGraph> from(
            @Name("data") Object data, @Name("name") String name, @Name("properties") Map<String, Object> properties) {
    ...
    public Stream<VirtualGraph> fromPath(
            @Name("path") Path paths, @Name("name") String name, @Name("properties") Map<String, Object> properties) {
    ...
    public Stream<VirtualGraph> fromCypher(
        ...
        tx.execute(Cypher.withParamMapping(statement, params.keySet()), params).stream()
                .forEach(row -> {
                    row.forEach((k, v) -> {
