...
public class TriggerDeprecatedProcsHandler extends LifecycleAdapter implements TransactionEventListener<Void> {
    ...
    public TriggerDeprecatedProcsHandler(GraphDatabaseService db, DatabaseManagementService databaseManagementService,
