...
// TODO PATH FAILS            testIsTypeName(path, "PATH");
    ...
    public void testMetaArray() throws Exception {
        ...
        Map<String, Object> param = map(
                ...
                "ARRAY_POINT", new Object[]{Values.pointValue(CoordinateReferenceSystem.WGS_84, 56.d, 12.78), Values.pointValue(CoordinateReferenceSystem.WGS_84_3D, 56.d, 12.78, 100)},
    ...
    public void testMetaList() throws Exception {
        ...
        Map<String, Object> param = map(
                ...
                "LIST POINT", asList(Values.pointValue(CoordinateReferenceSystem.WGS_84, 56.d, 12.78), Values.pointValue(CoordinateReferenceSystem.CARTESIAN_3D, 2.3, 4.5, 1.2)),
