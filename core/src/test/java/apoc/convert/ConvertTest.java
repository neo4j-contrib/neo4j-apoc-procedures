...
public class ConvertTest {
    ...
    public void testToMap() throws Exception {
        testCall(
                ...
                map("a", map("a", "b")),
                r -> assertEquals(map("a", "b"), r.get("value")));
        ...
        testCall(
                db,
                "create (n) set n=$props return apoc.convert.toMap(n) as value",
                map("props", props),
                r -> assertEquals(props, r.get("value")));
    }
    ...
    public void testToList() throws Exception {
        ...
        testCall(
                db,
                "return apoc.convert.toList($a) as value",
                map("a", new Object[] {"a"}),
        ...
        testCall(
                db,
                "return apoc.convert.toList($a) as value",
                map("a", singletonList("a")),
                r -> assertEquals(singletonList("a"), r.get("value")));
        testCall(
                db,
                "return apoc.convert.toList($a) as value",
                map("a", singletonList("a").iterator()),
                r -> assertEquals(singletonList("a"), r.get("value")));
    }
    ...
    public void testToSet() throws Exception {
        ...
        testCall(
                db,
                "return apoc.convert.toSet($a) as value",
                map("a", new Object[] {"a"}),
                r -> assertEquals(singletonList("a"), r.get("value")));
        testCall(
                db,
    ...
    public void testToStringList() throws Exception {
        testCall(
                db,
                "return apoc.convert.toStringList([null, 'a', 1, true, [1]]) as value",
    ...
    public void testToIntList() throws Exception {
        testCall(
                db,
                "return apoc.convert.toIntList([null, 1, '1']) as value",
    ...
    public void testToBooleanList() throws Exception {
        testCall(
                db,
                "return apoc.convert.toBooleanList(['false', 0, 'no', '', null]) as value",
                r -> assertEquals(Arrays.asList(false, false, false, false, false), r.get("value")));
        testCall(
                db,
                "return apoc.convert.toBooleanList(['true', 1, 'yes']) as value",
