...
public class ConvertJsonTest {
    ...
    public void testToJsonListOfPath() throws Exception {
        testCall(
                db,
                "CREATE p=(a:Test {foo: 7})-[:TEST]->(b:Baa:Baz {a:'b'}), q=(:Omega {alpha: 'beta'})<-[:TEST_2 {aa:'bb'}]-(:Bar {one:'www'}) RETURN apoc.convert.toJson(collect(p)+q) AS value",
                (row) -> {
                    List<String> test = List.of("Test");
                    List<String> bar = List.of("Bar");
    ...
    @Test
    public void testFromJsonMap() throws Exception {
    ...
    @Test
    public void testSetJsonProperty() throws Exception {
        testCall(
                db,
    ...
    @Test
    public void testGetJsonProperty() throws Exception {
        testCall(
                db,
    ...
    @Test
    public void testGetJsonPropertyMap() throws Exception {
        testCall(
                db,
    ...
    @Test
    public void testToTreeIssue1685() throws Exception {
    ...
    @Test
    public void testToTreeUpperCaseRels() throws Exception {
        testCall(
                db,
                "CREATE p1=(m:Movie {title:'M'})<-[:ACTED_IN {role:'R1'}]-(:Actor {name:'A1'}), "
                        + " p2 = (m)<-[:ACTED_IN  {role:'R2'}]-(:Actor {name:'A2'}) WITH [p1,p2] as paths "
    ...
    @Test
    public void testTreeOfEmptyList() throws Exception {
    ...
    @Test
    public void testToTreeLeafNodes() throws Exception {
    ...
    @Test
    public void testToJsonMapSortingProperties() throws Exception {
        testCall(
                db,
    ...
    @Test
    public void testToJsonMapSortingPropertiesIgnoringCase() throws Exception {
        testCall(
                db,
