...
public class ExportCsvNeo4jAdminTest {
    ...
    private static final String EXPECTED_NEO4J_ADMIN_IMPORT_HEADER_TYPES_NODE = String.format(
            ":ID;born_3D:point;localtime:localtime;time:time;localDateTime:localdatetime;duration:duration;dateTime:datetime;born_2D:point;date:date;:LABEL%n");

    private static final String EXPECTED_NEO4J_ADMIN_IMPORT_TYPES_NODE = String.format(
            "6;\"{\"\"crs\"\":\"\"wgs-84-3d\"\",\"\"latitude\"\":12.78,\"\"longitude\"\":56.7,\"\"height\"\":100.0}\";12:50:35.556;12:50:35.556+01:00;2018-10-30T19:32:24;P5M1DT12H;2018-10-30T12:50:35.556+01:00;\"{\"\"crs\"\":\"\"cartesian\"\",\"\"x\"\":2.3,\"\"y\"\":4.5,\"\"z\"\":null}\";2018-10-30;Types%n");
    ...
    public void testExportCypherWithIdField() throws Exception {
        ...
        final Map<String, Object> map = db.executeTransactionally(
                ...
                result -> Iterators.single(result));
        ...
        TestUtil.testCall(
                ...
                r -> {
                    ...
                    String expectedNodesLarus = String.format(
                            ":ID,name,id:long,:LABEL%n" + "%s,Andrea,1,User;Larus%n", map.get("sourceId"));
                    String expectedNodesNeo4j = String.format(
                            ":ID,name,id:long,:LABEL%n" + "%s,Michael,2,User;Neo4j%n", map.get("targetId"));
