...
public class CloneSubgraphTest {
    ...
    public void testCloneSubgraph_From_RootA_With_Empty_Rels_Should_Clone_All_Relationships_Between_Nodes() {
        TestUtil.testCall(
                ...
                (row) -> {
                    assertThat(
                            (List<String>) row.get("cloneNames"),
                            containsInAnyOrder(
                                    "node1", "node2", "node3", "node4", "node5", "node8", "node9", "node10", "node6",
                                    "node7"));
                    assertThat(
                            (List<String>) row.get("cloneRelNames"),
                            containsInAnyOrder(
                                    "node1 LINK node5",
                                    "node1 LINK node2",
                                    "node2 LINK node3",
    ...
    public void testCloneSubgraph_With_Standins_For_Node1_Should_Have_RootB() {
        ...
        TestUtil.testCall(
                ...
                (row) -> {
                    assertThat(
                            (List<String>) row.get("bLinkedNodeNames"), containsInAnyOrder("node5", "node2", "node11"));
    ...
    public void
        ...
        TestUtil.testCall(
                db, "MATCH ()-[r]->() " + "WHERE not exists(r.id)" + "RETURN count(r) as relsWithNoId", (row) -> {
    ...
    public void
        ...
        TestUtil.testCall(
                ...
                (row) -> {
                    assertThat(
                            (List<String>) row.get("node12LinkedNodeNames"),
                            containsInAnyOrder("node1", "node9", "node8", "node6"));
    ...
    public void testCloneSubgraph_With_Rels_Not_Between_Provided_Nodes_Or_Standins_Should_Be_Ignored() {
        TestUtil.testCall(
                ...
                (row) -> {
                    assertThat(
                            (List<String>) row.get("cloneNames"),
                            containsInAnyOrder("node1", "node2", "node3", "node4", "node5", "node8", "node9", "node6"));
                });
